...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {         
            return Emps.Where(e => e.Job == "Backend programmer" && e.Salary > 1000).OrderByDescending(e => e.Ename);
        }
        ...
        {            
            return Emps.GroupBy(e => e.Job).Select(e => new {
                Praca = e.Key,
        ...
        {           
            return Emps.Join(Depts, emp => emp.Deptno, dept => dept.Deptno, (emp, dept) => new
            {
                ...
                emp.Job,
                emp.HireDate
            }).Where(e => e.Deptno > 1).GroupBy(e => e.Dname).Select(e => new
            {
                Name = e.Key,
        ...
        {
            return arr.GroupBy(e => e).Where(el => el.Count()%2==1).Select(el => el.Key).FirstOrDefault();
        }
        ...
        {
            return Depts.Where( d => new List<int>(){0,5}.Contains(Emps.Where( e => d.Deptno == e.Deptno).Count())).Select( e => e ).OrderBy( e => e.Dname );
        }
    }
